...
class DeepLinkService {
  ...
  /// Extrae el token de autenticación de una URI y el mapa raw del MethodChannel.
  /// Acepta múltiples nombres de query param (el backend puede variar) y tiene
  /// un fallback para rutas tipo /confirm/{token}.
  static String? extractToken(Uri uri, Map<dynamic, dynamic> raw) {
    final rawToken = raw['token'] as String?;
    if (rawToken != null && rawToken.isNotEmpty) return rawToken;
