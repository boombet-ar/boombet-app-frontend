...
class RaffleService {
  ...
  // ── Crear sorteo (wizard) — devuelve el modelo creado para obtener el ID ─────
  Future<RaffleModel> createRaffleForWizard({
    required String text,
    required DateTime fechaFin,
    int cantidadGanadores = 1,
    int? eventoId,
    required String emailPresentador,
    int? casinoGralId,
    String? instrucciones,
    Uint8List? imageBytes,
    String? imageName,
    ...
    final payload = <String, dynamic>{
      ...
      'fechaFin': _toIso8601WithOffset(fechaFin),
      'cantidadGanadores': cantidadGanadores,
      'premios': <Map<String, dynamic>>[
        {'nombre': 'Premio principal', 'imgUrl': '', 'orden': 1},
      ],
      'activo': true,
      'emailPresentador': emailPresentador,
      if (casinoGralId != null) 'casinoGralId': casinoGralId,
    ...
    if (decoded is Map<String, dynamic>) return RaffleModel.fromMap(decoded);
