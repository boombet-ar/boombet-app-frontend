    ...
    showDialog<void>(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: const Text(
            '• Tocá la pantalla para soltar el bloque.\n'
            '• Intenta alinearlo con la torre. Si lo haces perfecto sumas mas puntos.\n'
            '• Si el bloque cae afuera o muy en el borde, perdes.\n',
